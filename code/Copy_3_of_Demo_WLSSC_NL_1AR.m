...
for lambdasc = [0.05]
    par.lambdasc = lambdasc;
        for lambdals1 = 1.5:0.5:5
            par.lambdals1 = lambdals1;
            PSNR = [];
            SSIM = [];
            CCPSNR = [];
            CCSSIM = [];
            ...
            mCCPSNR = mean(CCPSNR);
            mCCSSIM = mean(CCSSIM);
            save(['WLSSC_NL_1AR_lsc' num2str(lambdasc) '_lls1' num2str(lambdals1) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
        end
end