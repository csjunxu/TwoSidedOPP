...
for delta = 0.05
    ...
    for lambdasc = 0.2:0.1:1
        ...
        for i = 1:im_num
            ...
            %
            time0 = clock;
            [im_out, par]  =  WLSWSC_Sigma_1AG(par);
            if size(par.I,1) == 512
        ...
        name = sprintf(['WLSWSC_m' num2str(par.model) '_nSig' num2str(nSig) '_delta' num2str(delta) '_lsc' num2str(lambdasc) '_WIter' num2str(par.WWIter) '.mat']);
